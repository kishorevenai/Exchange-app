...
class SubscriptionManager {
    constructor() {
        ...
        this.redisCallbackHandler = (message, channel) => {
            ...
            (_a = this.reverseSubscriptions
                .get(channel)) === null || _a === void 0 ? void 0 : _a.forEach((s) => { var _a; return (_a = UserManager_1.UserManager.getInstance().getUser(s)) === null || _a === void 0 ? void 0 : _a.emit(parsedMessage); });
        };
    ...
    subscribe(userId, subscription) {
        ...
        // const subscriptions = {
        //   user1: ["depth@eth_usdc", "trades@eth_usdc"],
        // };
        // const reverseSubscriptions = {
        //   "depth@eth_usdc": ["user1"],
        //   "trade@eth_usdc": ["user1"],
        // };
